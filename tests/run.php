...
toolbox_assert( false !== strpos( $admin_page, 'data-toolbox-connector-target="vector" aria-selected="false"' ) && false !== strpos( $admin_page, 'data-toolbox-connector-panel="vector"' ), 'Connector settings expose a Cloud-managed Vector verification section.' );
toolbox_assert( false !== strpos( $admin_page, 'Test vector search' ) && false !== strpos( $admin_page, 'data-toolbox-site-knowledge-search' ), 'Vector connector exposes a read-only Cloud site knowledge search check.' );
toolbox_assert( false !== strpos( $admin_page, 'Open index' ) && false !== strpos( $admin_page, 'toolbox_tab=site-knowledge' ), 'Vector connector links indexing operations back to Site Knowledge.' );
...
toolbox_assert( false !== strpos( $admin_page, 'data-toolbox-connector-panel="image"' ) && false !== strpos( $admin_page, 'Image source smoke test' ) && false !== strpos( $admin_page, 'Test Cloud image source' ) && false !== strpos( $admin_page, 'Candidate count' ), 'Image connector exposes a Cloud provider smoke-test flow.' );
...
toolbox_assert( false !== strpos( $admin_page, 'admin.php?page=magick-ai-cloud-addon' ) && false === strpos( $admin_page, 'https://qdrant.tech/' ), 'Connector provider rows expose Cloud Addon entries without local vector vendor links.' );
