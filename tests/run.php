...
toolbox_assert( false !== strpos( $editor_css, 'npcink-toolbox-editor-support__prompt-card' ) && false !== strpos( $editor_css, 'npcink-toolbox-editor-support__image-regenerate' ), 'Editor Content Support CSS styles AI image direction cards and regenerate controls.' );
