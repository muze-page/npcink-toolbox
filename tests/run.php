...
foreach ( array( 'writing_support', 'publish_preflight', 'summary_terms_optimization', 'internal_links', 'image_candidates' ) as $editor_intent ) {
	toolbox_assert( false !== strpos( $editor_js, $editor_intent ), "Editor Content Support exposes fixed flow intent {$editor_intent}." );
}
toolbox_assert( false === strpos( $editor_js, "intent: 'taxonomy_tags'" ) && false === strpos( $editor_js, 'Recommend existing terms' ), 'Editor Content Support keeps the visible writing loop to five primary buttons.' );
...
toolbox_assert( false !== strpos( $editor_js, 'renderContentMetadataDelta' ) && false !== strpos( $editor_js, 'Content Metadata Delta' ) && false !== strpos( $editor_js, 'Delta categories' ) && false !== strpos( $editor_js, 'Outcome checks' ), 'Editor Content Support renders the Content Metadata Delta artifact as a visible review section.' );
...
toolbox_assert( false !== strpos( $editor_js, 'content_metadata_delta_handoff' ) && false !== strpos( $editor_js, 'Submit Core review proposal' ), 'Editor Content Support presents accepted metadata choices as explicit Core review proposal creation.' );
toolbox_assert( false !== strpos( $editor_js, 'Summary layers' ) && false !== strpos( $editor_js, 'Ranking and dedupe strategy' ) && false !== strpos( $editor_js, 'Review metrics' ), 'Editor Content Support renders summary precision layers, dedupe strategy, and review metrics.' );
toolbox_assert( false !== strpos( $editor_js, 'Input scope' ) && false !== strpos( $editor_js, 'Category candidates' ) && false !== strpos( $editor_js, 'Tag candidates' ) && false !== strpos( $editor_js, 'Proposed new terms' ) && false !== strpos( $editor_js, 'Core handoff candidates' ) && false !== strpos( $editor_js, 'Handoff preview' ), 'Editor Content Support folds existing-term recommendations into broader metadata optimization.' );
