...
toolbox_assert( false !== strpos( $editor_js, 'Recommend existing terms' ) && false !== strpos( $editor_js, 'Input scope' ) && false !== strpos( $editor_js, 'Proposed new terms' ) && false !== strpos( $editor_js, 'Core handoff candidates' ) && false !== strpos( $editor_js, 'Handoff preview' ), 'Editor Content Support distinguishes existing-term recommendations, Core handoff candidates, and broader metadata optimization.' );
...
toolbox_assert( false !== strpos( $rest, "'proposal_targets'" ) && false !== strpos( $rest, "'npcink-abilities-toolkit/update-post'" ) && false !== strpos( $rest, "'npcink-abilities-toolkit/set-post-terms'" ), 'REST metadata handoff preview exposes real Core-governed target abilities.' );
