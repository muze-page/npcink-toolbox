...
toolbox_assert( false !== strpos( $admin_js, 'Input scope' ) && false !== strpos( $admin_js, 'Proposed new terms' ) && false !== strpos( $admin_js, 'Auto-apply candidates' ) && false !== strpos( $admin_js, 'Handoff preview' ) && false !== strpos( $admin_js, 'Handoff preview packet' ), 'Admin JavaScript separates scope, proposed new terms, auto-apply candidates, and Core handoff preview in metadata optimization results.' );
...
toolbox_assert( false !== strpos( $editor_js, 'Recommend existing terms' ) && false !== strpos( $editor_js, 'Input scope' ) && false !== strpos( $editor_js, 'Proposed new terms' ) && false !== strpos( $editor_js, 'Auto-apply candidates' ) && false !== strpos( $editor_js, 'Handoff preview' ), 'Editor Content Support distinguishes existing-term recommendations, auto-apply candidates, and broader metadata optimization.' );
