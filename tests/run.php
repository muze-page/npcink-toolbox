...
toolbox_assert( false !== strpos( $editor_js, "postJson('ai/image-generation'" ) && false !== strpos( $editor_js, 'Generate image' ) && false !== strpos( $editor_js, 'editor_image_source_modal_generation' ), 'Editor image recommendation modal exposes direct AI image generation from a reviewed prompt.' );
